  ...
  render() {
    if (this.props.nombrePages > 1) {
      ...
      <nav className="PaginateNav mx-auto" aria-label="Page navigation example">
          ...
          <li className="page-item" ><a className="prev page-link" id="-1" onClick={this.props.action}>Précédent</a></li>
                  {this.makeRenderPageNumbers()}
          <li className="page-item"><a className="next page-link" id="-2" onClick={this.props.action}>Suivant</a></li>
          </ul>
      </nav>
    );
  } else {
